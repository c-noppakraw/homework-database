...
<?php
  ...
  $showdata = "SELECT * FROM raw_meat ORDER BY M_ID asc";
...
<div class="box col-sm-10">
  ...
  <h3><i class="fa fa-table" aria-hidden="true"></i> Meat Table</h3>
</div>
<div class="col-sm-1"></div>
...
<table class="table table-striped"><br>
  ...
  <?php
      while ($recond = mysqli_fetch_array($getquery)) {
        echo "<tr>";
        echo "<td>" .$recond["M_ID"]. "</td>";
        echo "<td>" .$recond["MeatName"]. "</td>";
